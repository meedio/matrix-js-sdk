...
export class MatrixRTCSession extends TypedEventEmitter {
  ...
  constructor(client, roomSubset, memberships) {
    ...
    this.e2eeLogger = rootLogger.getChild("[E2EE_FLOW_MX][RTC_SESSION]");
  ...
  joinRoomSession(fociPreferred, fociActive, joinConfig) {
    ...
    if (this.isJoined()) {
      ...
      this.e2eeLogger.info("Joining MatrixRTC session", this.logContext);
      ...
      if (joinConfig !== null && joinConfig !== void 0 && joinConfig.useExperimentalToDeviceTransport) {
        this.e2eeLogger.info("Using experimental to-device with room fallback transport for encryption keys", this.logContext);
        ...
        this.e2eeLogger.info("Using normal transport for encryption keys", this.logContext);
      ...
      this.encryptionManager = new EncryptionManager(this.client.getUserId(), this.client.getDeviceId(), () => this.memberships, transport, this.statistics, (keyBin, encryptionKeyIndex, participantId) => {
        this.e2eeLogger.info("Emitting EncryptionKeyChanged, LiveKit should receive this key.", _objectSpread({
    ...
    this.e2eeLogger.info("Joining in membershipManager and encryptionManager, emitting JoinStateChanged", this.logContext);

    // Join!
    this.membershipManager.join(fociPreferred, fociActive, e => {
      this.e2eeLogger.error("MembershipManager encountered an unrecoverable error: ", _objectSpread(_objectSpread({}, this.logContext), {}, {
        e
      }));
  ...
  leaveRoomSession() {
    ...
    return _asyncToGenerator(function* () {
      ...
      _this2.e2eeLogger.info("Leaving call session in room ".concat(_this2.roomSubset.roomId), _this2.logContext);
  ...
  reemitEncryptionKeys() {
    var _this$encryptionManag2, _this$encryptionManag3;
    this.e2eeLogger.info("Re-emitting EncryptionKeyChanged for ".concat((_this$encryptionManag2 = this.encryptionManager) === null || _this$encryptionManag2 === void 0 ? void 0 : _this$encryptionManag2.getEncryptionKeys().size, " keys"), this.logContext);
    (_this$encryptionManag3 = this.encryptionManager) === null || _this$encryptionManag3 === void 0 || _this$encryptionManag3.getEncryptionKeys().forEach((keys, participantId) => {
   ...
   */
  getEncryptionKeys() {
    var _this$encryptionManag4, _this$encryptionManag5;
    var keys = (_this$encryptionManag4 = (_this$encryptionManag5 = this.encryptionManager) === null || _this$encryptionManag5 === void 0 ? void 0 : _this$encryptionManag5.getEncryptionKeys()) !== null && _this$encryptionManag4 !== void 0 ? _this$encryptionManag4 : new Map();
